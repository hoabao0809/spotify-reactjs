...
export const YourLibraryActiveIcon = ({
  width = '2.4rem',
  height = '2.4rem',
  className,
}) => (
...
export const LyricsIcon = ({ width = '16px', height = '16px', className }) => (
  <svg
    role="img"
    height={height}
    width={width}
...
export const QueueIcon = ({ width = '16px', height = '16px', className }) => (
  <svg
    role="img"
    height={height}
    width={width}
